...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum_game.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_game"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_game:externalType",
                '',
                data)
        return extRecord
