...
# (str) Package name
package.name = Electrum_GAME

# (str) Package domain (needed for android/ios packaging)
package.domain = org.electrum_game
...
source.exclude_dirs = bin, build, dist, contrib, electrum_game/gui/qt, electrum_game/gui/kivy/tools, electrum_game/gui/kivy/theming/light
# (list) List of exclusions using pattern matching
source.exclude_patterns = Makefile,setup*

# (str) Application versioning (method 1)
version.regex = APK_VERSION = '(.*)'
version.filename = %(source.dir)s/electrum_game/version.py
...
android.add_src = electrum_game/gui/kivy/data/java-classes/
...
android.manifest.intent_filters = electrum_game/gui/kivy/tools/bitcoin_intent.xml
