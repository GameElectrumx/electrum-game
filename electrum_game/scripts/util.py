...
from electrum_game.network import parse_servers
...
def get_peers():
    ...
    if server is None:
        print("You need to set a secure server, for example (for mainnet): 'electrum-game setconfig server electrum-game.bysh.me:50002:s'")
        return []
