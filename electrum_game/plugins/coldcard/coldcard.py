...
from electrum_game.bitcoin import serialize_xpub, deserialize_xpub, InvalidMasterKeyVersionBytes
from electrum_game import constants
from electrum_game.bitcoin import TYPE_ADDRESS, int_to_hex
from electrum_game.i18n import _
from electrum_game.plugin import BasePlugin, Device
from electrum_game.keystore import Hardware_KeyStore, xpubkey_to_pubkey, Xpub
from electrum_game.transaction import Transaction
from electrum_game.wallet import Standard_Wallet
from electrum_game.crypto import hash_160
from ..hw_wallet import HW_PluginBase
from ..hw_wallet.plugin import is_any_tx_output_on_change_branch
from electrum_game.util import print_error, bfh, bh2u, versiontuple
...
try:
    ...
    class ElectrumColdcardDevice(ColdcardDevice):
        ...
        def mitm_verify(self, sig, expect_xpub):
            ...
            from electrum_game.ecc import ECPubkey
