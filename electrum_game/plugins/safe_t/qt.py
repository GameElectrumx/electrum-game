...
from electrum_game.plugin import hook, DeviceMgr
from electrum_game.util import PrintError, UserCancelled, bh2u
from electrum_game.wallet import Wallet, Standard_Wallet
    ...
    def request_safe_t_init_settings(self, wizard, method, device):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electrum_game.keystore import is_xprv
