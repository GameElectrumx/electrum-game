...
try:
    from electrum_game.crypto import Hash, EncodeAES, DecodeAES
    from electrum_game.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh, is_address,
                                      serialize_xpub, deserialize_xpub)
    from electrum_game import ecc
    from electrum_game.ecc import msg_magic
    ...
    from electrum_game.keystore import Hardware_KeyStore
    from ..hw_wallet import HW_PluginBase
    from electrum_game.util import print_error, to_string, UserCancelled
    from electrum_game.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-GAME-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
