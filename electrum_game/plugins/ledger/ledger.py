...
from electrum_game import bitcoin, constants
from electrum_game.bitcoin import TYPE_ADDRESS, int_to_hex, var_int
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "GameCredits" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise Exception(_("Device not in GameCredits mode")) from e
                raise e
